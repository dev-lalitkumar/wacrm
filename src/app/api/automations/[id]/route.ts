...
// Automations are admin/owner-only — RLS already enforces this when
// the user-scoped client is used. This route runs on the service-role
// client (legacy pattern), so role-gating happens here too.
