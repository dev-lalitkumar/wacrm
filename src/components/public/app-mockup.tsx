...
import { MockupNavRail } from "./mockups/mockup-nav-rail";
import { cn } from "@/lib/utils";

const CONVERSATIONS = [
  {
    name: "Aarav Mehta",
    msg: "Great, send me the proposal \u{1F64C}",
    time: "2m",
    unread: 2,
    active: true,
    tag: "Hot lead",
...
const THREAD = [
  ...
  {
    from: "me",
    text: "Welcome \u{1F44B} Happy to help. I've added you to our pipeline.",
    time: "10:25",
  },
            ...
            {CONVERSATIONS.map((c) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {c.tag && (
                    <span className="mt-1 inline-block rounded bg-primary/20 px-1.5 py-0.5 text-[9px] font-medium text-primary">
                      {c.tag}
                    </span>
                  )}
                </div>
        ...
        <div className="flex flex-1 flex-col bg-[#0a0a10]">
          <div className="flex items-center justify-between border-b border-white/5 px-4 py-3">
            <div className="flex items-center gap-3">
              <span className="flex size-9 items-center justify-center rounded-full bg-gradient-to-br from-primary/40 to-indigo-500/30 text-xs font-semibold text-white">
                AM
              </span>
              <div>
          ...
          <div className="flex items-center gap-2 border-t border-white/5 p-3">
            ...
            <div className="flex-1 rounded-full bg-white/5 px-4 py-2 text-[12px] text-muted-foreground">
              Type a message…
            </div>
